...
public class BouncingGamePlayerBehaviour : MonoBehaviour {
	...
	void Update () {
		...
		if(hasStartedLevel == true){
			translation = horizontalSpeed * Time.deltaTime;
    ...
    {
		if(other.gameObject.CompareTag("BouncingLeftWall") || other.gameObject.CompareTag("BouncingRightWall")){
